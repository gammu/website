    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(help_text='Used in the URL of the entry. Must be unique for the publication date of the entry.', unique_for_date='pub_date')),
                ('title', models.CharField(max_length=250)),
                ('body', models.TextField()),
                ('body_html', models.TextField(editable=False, blank=True)),
                ('excerpt', models.TextField(null=True, blank=True)),
                ('excerpt_html', models.TextField(null=True, editable=False, blank=True)),
                ('identica_post', models.NullBooleanField(default=False, verbose_name='post to identi.ca')),
                ('identica_text', models.CharField(max_length=100, null=True, verbose_name='identi.ca post text', blank=True)),
