...
urlpatterns = [
    ...
    url(r'^manual/$', RedirectView.as_view(url='https://docs.gammu.org/', permanent=True)),
    url(r'^docs/faq/$', RedirectView.as_view(url='https://docs.gammu.org/faq/', permanent=True)),
    url(r'^docs/roadmap/$', RedirectView.as_view(url='https://docs.gammu.org/project/roadmap.html', permanent=True)),
